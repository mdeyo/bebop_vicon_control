...
if __name__ == "__main__":
    ...
    pub_x = rospy.Publisher(bebop_ns + '/state/x', Float64, queue_size=10)
    pub_y = rospy.Publisher(bebop_ns + '/state/y', Float64, queue_size=10)
    pub_z = rospy.Publisher(bebop_ns + '/state/z', Float64, queue_size=10)
    pub_yaw = rospy.Publisher(bebop_ns + '/state/yaw', Float64, queue_size=10)
